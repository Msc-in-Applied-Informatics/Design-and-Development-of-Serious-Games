   ...
   public Home(int width,int height, String path, String type, int theTypeTile){
    ...
    {  
        if(getY() >getWorld().getHeight() /2)
            getWorld().setPaintOrder(Announce.class,Weather.class,Animation.class,Attention.class,Door.class,Paralize.class,Player.class,Animal.class,Egg.class,Home.class,Fountain.class,Item.class, Tile.class);
        else
            getWorld().setPaintOrder(Announce.class,Weather.class,Animation.class,Attention.class,Door.class,Home.class,Paralize.class,Player.class,Animal.class,Egg.class,Fountain.class,Item.class, Tile.class);
    }
